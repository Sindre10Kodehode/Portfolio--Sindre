export const Hero = () => {
  return (
    <section
      id="hero"
      className="bg-[url(/blob-scene-haikei.svg)] bg-no-repeat bg-cover z-50 w-full h-screen flex flex-col md:flex-row place-content-center justify-around items-center text-gray-300 font-Poppins"
    >
