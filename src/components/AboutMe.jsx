export const AboutMe = () => {
  ...
  return (
    <div className=" w-[500px] p-4 font-Lato">
      ...
      <Pstyle>Med mine mange og lange erfaringer fra aktivt arbeid i musikkindustrien kan jeg fort og effektivt sette meg inn i nye ting, samtidig som jeg er godt rutinert i å lære nye ting. Få ting er vært å gjøre om man får det til på første forsøk. jeg lever på forbedringspotensiale. </Pstyle>
    </div>
  );
};
